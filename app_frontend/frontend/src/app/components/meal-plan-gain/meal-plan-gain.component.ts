...
export class MealPlanGainComponent implements OnInit{
  ...
  constructor(private foodService: FoodService, private exerciseService: ExerciseService, private userService: UserService, private titleService: Title) {
    
  }

  ngOnInit(): void {
    this.titleService.setTitle('Here is you plan to gain')
    this.getFoods();
    this.getExercises();
